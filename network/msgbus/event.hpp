...
namespace cytx {
    ...
    protected:
        static Family get_family_id()
        {
            static Family family_counter = 0;
            return family_counter++;
        }
    };


    typedef cytx::Signal<void(const void*)> EventSignal;
    ...
    public:
        ...
        static Family family() {
            static Family family = get_family_id();
            return family;
        }
    };
